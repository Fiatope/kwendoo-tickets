...
Devise.setup do |config|
  ...
  config.mailer_sender = "Kwendoo Tickets <contact@kwendoo.com>"
  ...
  # config.mailer.delivery_method = :test
  # config.mailer.default_url_options = { :host => 'localhost:3000' }
  # config.mailer.perform_deliveries = false
  # config.mailer.raise_delivery_errors = false
  # config.mailer.smtp_settings = {
  #   address: 'smtp.mandrillapp.com',
  #   port: '587',
  #   authentication: :plain,
  #   user_name: 'eric_njedjou@hotmail.com',
  #   password: 'Qa82dJ-r9OEoNAqCxZNo6Q',
  ...
  if Rails.env.test?
    ...
    begin
      config.omniauth :facebook, ENV['FACEBOOK_APP_ID'], ENV['FACEBOOK_SECRET'], scope: ''
      ...
      #   OauthProvider.all.each do |p|
    	#   if p.name == 'openid_connect'
    	#     config.omniauth p.name, { client_options: { identifier: p.key, secret: p.secret}, scope: p.scope }
      #     else
