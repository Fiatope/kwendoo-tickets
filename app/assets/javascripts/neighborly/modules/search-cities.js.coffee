Neighborly.SearchCities = (searchInputSelctor, mapCanvasSelector) ->
  ...
  $.getScript('https://maps.googleapis.com/maps/api/js?key=AIzaSyBV-NXsHfggsYT6CMgXdXAT3xb4aYqlYhU&v=3.exp&sensor=false&libraries=places&callback=Neighborly.SearchCitiesInitialize')
