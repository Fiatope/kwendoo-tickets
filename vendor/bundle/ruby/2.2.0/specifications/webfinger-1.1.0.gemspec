...
Gem::Specification.new do |s|
  ...
  s.date = "2017-12-11"
  s.description = "Ruby WebFinger client library"
  s.email = ["nov@matake.jp"]
  s.homepage = "https://github.com/nov/webfinger"
  s.licenses = ["MIT"]
  s.rubygems_version = "2.4.5.2"
  s.summary = "Ruby WebFinger client library, following IETF WebFinger WG spec updates."
